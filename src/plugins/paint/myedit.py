...
#        super().__init__(
#            canvas.static,
#            style=WS_CHILD | ES_LEFT | ES_MULTILINE | WS_THICKFRAME,
#        )
        super().__init__(
            WC_EDIT,
...
#            wrap_hwnd=wrap_hwnd
        ...
        self.send_message(EM_SETMARGINS, EC_LEFTMARGIN | EC_RIGHTMARGIN, 0)
    ...
    def _zoom_changed(self, zoom):
        ...
        font_dict = dict(self.font_dict)
        font_dict['font_size'] = round(font_dict['font_size'] * zoom)
        super().set_font(**font_dict)
    ...
    def set_font(self, font_dict):
        ...
        font_dict['font_size'] = round(font_dict['font_size'] * self.zoom)
        super().set_font(**font_dict)
    ...
    ########################################
    # Edit's rect relative to static
    ########################################
    def get_rect(self):
        rc = self.get_window_rect()
...
#
#        self.font_dict['font_size'] = round(self.font_dict['font_size'] * f)
#        super().set_font(**self.font_dict)
#
#        self.set_window_pos(
#            round(rc.left * f),
#            round(rc.top * f),
